...
$(document).ready(function() {
	...
	// 点击向左轮播的函数
	$(".carousel .img_btn .btn_l").click(function() {
		i--;
		if(i == -1) {
			$(".carousel .img").css({
				"left": mywidth - (size - 1) * 1920,
				"margin-left": "-960px"
			});
			i = size - 2;
		}
		$(".carousel .img").stop().animate({
			"left": mywidth - i * 1920,
			"margin-left": "-960px"
		});
		$(".carousel .img_nav li").eq(i).addClass("on").siblings().removeClass("on");
	});
	//  点击向右轮播的函数
	$(".carousel .img_btn .btn_r").click(function() {
		i++;
		if(i == size) {
			$(".carousel .img").css({
				"left": mywidth,
		...
		if(i == size - 1) {
			$(".carousel .img_nav li").eq(0).addClass("on").siblings().removeClass("on");
		} else {
			$(".carousel .img_nav li").eq(i).addClass("on").siblings().removeClass("on");
		}
	});
	...
	//  鼠标滑过白条导航条
	$(".carousel .img_nav li").hover(function() {
	...
	//鼠标点击白条导航条
	$(".carousel .img_nav li").click(function() {
		var index = $(this).index();
		i = index;
		$(".carousel .img").stop().animate({
			"left": mywidth - i * 1920,
	...
	$(".wrap4 dl.chose_brand dt").click(function(event) {
		...
		if(dd1 == "none") {
			$(this).css({
				"background-image": "url(img/new_icons.png)",
				"background-position": "292px -591px",
				"background-repeat": "no-repeat"
			});
		} else {
			$(this).css({
				"background-image": "url(img/new_icons.png)",
				"background-position": "292px -552px",
				"background-repeat": "no-repeat"
			});
		}
		$(this).next().slideToggle(250);
		$(".wrap4 dl.chose_type dd>div").slideUp(250, function() {
			$(".wrap4 dl.chose_type dt").css({
				"background-image": "url(img/new_icons.png)",
				"background-position": "292px -552px",
				"background-repeat": "no-repeat"
			});
	...
	$(".wrap4 dl.chose_type dd div div").click(function() {
		var get_text = $(this).text();
		$(this).parent().slideUp(250, function() {
			$(this).parent().prev().text(get_text).css({
				"background-image": "url(img/new_icons.png)",
				"background-position": "292px -552px",
				"background-repeat": "no-repeat"
			});
	...
	$(".wrap5 .lab .lab_main .lab_img").hover(function() {
		$(this).find(".img_container .list_bg").animate({
			"opacity": "0.7"
		}, 250);
		$(this).find(".img_container .left_line").animate({
			"left": "173px",
			"opacity": "1"
		}, 250);
		$(this).find(".img_container .right_line").animate({
			"right": "173px",
			"opacity": "1"
		}, 250);
		$(this).find(".img_container .play").animate({
			"top": "0",
			"opacity": "1"
		}, 250);
	}, function() {
		$(this).find(".list_bg").animate({
			"opacity": "0"
		}, 250);
		$(this).find(".left_line").animate({
			"left": "83px",
			"opacity": "0"
		}, 250);
		$(this).find(".right_line").animate({
			"right": "83px",
			"opacity": "0"
		}, 250);
